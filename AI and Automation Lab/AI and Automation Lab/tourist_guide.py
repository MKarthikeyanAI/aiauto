...
class TouristDestinations:
    ...
    def get_recommendations(self, location, spot, min_rating):
        ...
        for destination in self.destinations:
            #print(location)
            #print(destination.location.lower())
            if (not location or location.lower() in  destination.location.lower() ) and (not spot or destination.type.lower() == spot.lower()) \
                and (min_rating is None or destination.rating >= min_rating):
...
if __name__ == "__main__":
    ...
    tourist_destinations.load_destinations('destinations.json')
